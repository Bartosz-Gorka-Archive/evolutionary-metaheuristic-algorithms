...
public class SteepestLocalSolver {
    ...
    private HashMap<Integer, HashSet<Integer>> startGroups;
    ...
    public SteepestLocalSolver(HashMap<Integer, HashSet<Integer>> groups, boolean isCandidateAlgorithm, int candidatesNumber, boolean useCache) {
        ...
        for (Map.Entry<Integer, HashSet<Integer>> entry : groups.entrySet()) {
            ...
            this.startGroups.put(entry.getKey(), set);
        }
     ...
     */
    public void run(double[][] distanceMatrix, int numberOfIterations) {
        for (int iterationNo = 0; iterationNo < numberOfIterations; iterationNo++) {

            //init start groups instance
            this.groups = new HashMap<>();
            for (Map.Entry<Integer, HashSet<Integer>> entry : this.startGroups.entrySet()) {
                HashSet<Integer> set = new HashSet<>(entry.getValue());
